...
{
    internal class UpdateMonitorSettingCommandValidator : AbstractValidator<Action<ISubUserListQuery>>
    {
        private readonly Context _context;
        private readonly SubUserListQuery _subUserListQuery;

        public UpdateMonitorSettingCommandValidator(string defaultKey, Context context)
        {
            _context = context;
