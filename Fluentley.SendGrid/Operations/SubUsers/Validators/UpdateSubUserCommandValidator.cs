...
{
    internal class UpdateSubUserCommandValidator : AbstractValidator<Action<ISubUserListQuery>>
    {
        private readonly Context _context;
        private readonly SubUserListQuery _subUserListQuery;

        public UpdateSubUserCommandValidator(string defaultKey, Context context)
        {
            _context = context;
