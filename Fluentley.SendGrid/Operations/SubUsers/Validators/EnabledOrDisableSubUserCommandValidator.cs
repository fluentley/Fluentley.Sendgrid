...
{
    internal class EnabledOrDisableSubUserCommandValidator : AbstractValidator<Action<ISubUserListQuery>>
    {
        private readonly Context _context;
        private readonly SubUserListQuery _subUserListQuery;

        public EnabledOrDisableSubUserCommandValidator(string defaultKey, Context context)
        {
            _context = context;
